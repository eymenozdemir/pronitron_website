            ...
            <>
              ...
              <div data-custom-class="body">
                <div align="center" style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <strong>
                              <span
                                style={{ lineHeight: "22.5px", fontSize: 26 }}
                              >
                                END USER <bdt className="block-component" />
                                LICENSE
                      ...
                      >
                        <span
                          style={{ fontSize: "11pt", lineHeight: "16.8667px" }}
                        >
                          <strong>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <bdt className="question">stone nature</bdt> is licensed
                        to You (End-User) by{" "}
                        <bdt className="question">Stone Nature llc</bdt>,
                        located
                        <bdt className="block-component" /> and registered
                        <bdt className="statement-end-if-in-editor" /> at{" "}
                        <bdt className="question">1750 Young Ct</bdt>,
                        <span
                          style={{
                            fontSize: "11.0pt",
                            lineHeight: "115%",
                        ...
                        >
                          ...
                          <bdt className="question">Norcross</bdt>,{" "}
                          <bdt className="block-component" />
                          <bdt className="question">Georgia</bdt>
                          <bdt className="block-component" />{" "}
                          <bdt className="question">30093</bdt>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <bdt className="block-component" />
                        <bdt className="block-component" />
                        <bdt className="block-component" />, and any update
                        thereto (as permitted by this{" "}
                        <bdt className="block-component" />
                        License
                        <bdt className="statement-end-if-in-editor" />{" "}
                        Agreement), You indicate that You agree to be bound by
                        ...
                        License
                        <bdt className="statement-end-if-in-editor" />{" "}
                        Agreement. <bdt className="block-component" /> referred
                        to in this <bdt className="block-component" />
                        License
                        <bdt className="statement-end-if-in-editor" /> Agreement
                        as <bdt className="block-component" />"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        License
                        <bdt className="statement-end-if-in-editor" /> Agreement
                        and are not bound by any provisions or obligations with
                        regard to the Licensed Application, such as warranty,
                        liability, maintenance and support thereof.{" "}
                        <bdt className="question">Stone Nature llc</bdt>, not
                        the Services, is solely responsible for the Licensed
                  ...
                  >
                        ...
                        <span style={{ fontSize: 15 }}>
                          <bdt data-type="body">
                            ...
                            >
                              ...
                              License
                              <bdt className="statement-end-if-in-editor" />{" "}
                              Agreement may not provide for usage rules for the
                              Licensed Application that are in conflict with the
                              latest <bdt className="block-component" />
                              <bdt className="block-component" />
                              <bdt className="block-component" /> (
                              <bdt className="block-component" />"
                    ...
                    <div
                      ...
                      style={{ lineHeight: "1.5" }}
                    >
                      <bdt className="question">stone nature</bdt>{" "}
                      <bdt data-type="conditional-block">
                        <span style={{ fontSize: 15 }}>
                          <bdt data-type="body">
                            <span
                            ...
                            >
                              when purchased or downloaded through the Services,
                              is licensed to You for use only under the terms of
                              this <bdt className="block-component" />
                              License
                              <bdt className="statement-end-if-in-editor" />{" "}
                              Agreement. The Licensor reserves all rights not
                              expressly granted to You.{" "}
                              <bdt className="question">stone nature</bdt> is to
                              be used on devices that operate with{" "}
                              <bdt className="block-component" />
                              <bdt className="block-component" />
                              <bdt className="block-component" />.
                            </span>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <bdt className="statement-end-if-in-editor" />) is a
                        piece of software created to{" "}
                        <bdt className="question">
                          managing inventory of the stone nature llc.
                        </bdt>{" "}
                        ...
                        <bdt className="block-component" />
                        <bdt className="block-component" />
                        <bdt className="block-component" /> mobile devices (
                        <bdt className="block-component" />"
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        you may not use this Licensed Application. You may not
                        use the Licensed Application in a way that would violate
                                  ...
                                  >
                                    <bdt data-type="conditional-block">
                                      <bdt data-type="body">
                                        ...
                                        >
                                          1 &nbsp;You may not share or make the
                                          Licensed Application available to
                                          third parties (unless to the degree
                                          allowed by the Usage Rules, and with{" "}
                                          <bdt className="question">
                                            Stone Nature llc
                                          </bdt>
                                          's prior written consent), sell, rent,
                                          lend, lease or otherwise redistribute
                                    ...
                                    >
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            2 &nbsp;You may not reverse
                                            engineer, translate, disassemble,
                                            integrate, decompile, remove,
                                            modify, combine, create derivative
                                            works or updates of, adapt, or
                                            attempt to derive the source code of
                                            the Licensed Application, or any
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            ...
                                            license
                                            <bdt className="statement-end-if-in-editor" />{" "}
                                            and the Usage Rules) or alter the
                                            Licensed Application or portions
                                            thereof. You may create and store
                                            copies only on devices that You own
                                            or control for backup keeping under
                                            the terms of this{" "}
                                            <bdt className="block-component" />
                                            license
                                            <bdt className="statement-end-if-in-editor" />
                                            , the Usage Rules, and any other
                                            terms and conditions that apply to
                                            the device or software used. You may
                                            not remove any intellectual property
                                            notices. You acknowledge that no{" "}
                                            <bdt className="block-component" />
                                            unauthorized
                                            <bdt className="statement-end-if-in-editor" />{" "}
                                            third parties may gain access to
                                            these copies at any time. If you
                                            sell your Devices to a third party,
                                            you must remove the Licensed
                                            Application from the Devices before
                                            doing so.
                                            <span
                                              style={{
                                                fontSize: "11pt",
                                    ...
                                    >
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            4 &nbsp;Violations of the
                                            obligations mentioned above, as well
                                            as the attempt of such infringement,
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            ...
                                            third-party terms. When using the
                                            Licensed Application, You must
                  ...
                  >
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          <span
                                            style={{ color: "rgb(89, 89, 89)" }}
                                          >
                                            1 &nbsp;You acknowledge that it is
                                            Your responsibility to confirm and
                                            determine that the app end-user
                                            device on which You intend to use
                                            the Licensed Application satisfies
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          <span
                                            style={{ color: "rgb(89, 89, 89)" }}
                                          >
                                            2 &nbsp;Licensor reserves the right
                                            to modify the technical
                                            specifications as it sees
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            ...
                                            is not obligated, expressed or
                                            implied, to provide any maintenance,
                                ...
                                >
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      <font color="#595959">
                                        <span style={{ fontSize: 15 }}>
                                          &nbsp;and the End-User acknowledge
                                          that the Services have no obligation
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          <span
                                            style={{ color: "rgb(89, 89, 89)" }}
                                          >
                                            You acknowledge that Licensor will
                                            be able to access and adjust Your
                                            downloaded Licensed Application
                                            content and Your personal
                                            information, and that Licensor's use
                                            of such material and information is
                                            subject to Your legal agreements
                                            with Licensor and Licensor's privacy
                                            policy
                                            <bdt className="block-component" />:{" "}
                                            <bdt className="question">
                                              <a
                                                href="https://stonenaturesystem.com/admin/privacy-policy"
                                                target="_blank"
                                                data-custom-class="link"
                                              >
                                                https://stonenaturesystem.com/admin/privacy-policy
                                              </a>
                                            </bdt>
                                            <bdt className="block-component" />.
                                          </span>
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        peripherals, offer product support, facilitate the
                        software updates, and for purposes of providing other
                        services to you (if any) related to the Licensed
                        Application. Licensor may also use this information to
                        improve its products or to provide services or
                        technologies to you, as long as it is in a form that
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            ...
                                            other users of the Licensed
                                            Application and through third-party
                                            websites or applications. As such,
                                            any Contributions you transmit may
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        necessary <bdt className="block-component" />
                        licenses
                        ...
                        Licensed Application, and other users of the Licensed
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        or each and every such identifiable individual person to
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        to material that violates, any provision of this{" "}
                        <bdt className="block-component" />
                        License
                        <bdt className="statement-end-if-in-editor" />{" "}
                    ...
                    <div
                      className="MsoNormal"
                      style={{ lineHeight: 1, marginLeft: 20 }}
                    >
                      <br />
                    </div>
                    <div
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        foregoing violates this{" "}
                        <bdt className="block-component" />
                        License
                        <bdt className="statement-end-if-in-editor" /> Agreement
                        and may result in, among other things, termination or
                        suspension of your rights to use the Licensed
                        Application.
                      </span>
                    </div>
                    <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        Licensed Application or making Contributions accessible
                        to the Licensed Application by linking your account from
                        the Licensed Application to any of your social
                        networking accounts, you automatically grant, and you
                        represent and warrant that you have the right to grant,
                        to us an unrestricted, unlimited, irrevocable,
                        perpetual, non-exclusive, transferable, royalty-free,
                        fully-paid, worldwide right, and{" "}
                        <bdt className="block-component" />
                        license
                        <bdt className="statement-end-if-in-editor" /> to host,
                        use copy, reproduce, disclose, sell, resell, publish,
                        broad cast, retitle, archive, store, cache, publicly
                        ...
                        and to prepare derivative works of, or incorporate in
                        other works, such as Contributions, and grant and{" "}
                        <bdt className="block-component" />
                        authorize sublicenses
                        <bdt className="statement-end-if-in-editor" /> of the
                        foregoing. The use and distribution may occur in any
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        This <bdt className="block-component" />
                        license
                        <bdt className="statement-end-if-in-editor" /> will
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        in your Contributions provided by you in any area in the
                        Licensed Application. You are solely responsible for
                        your Contributions to the Licensed Application and you
                    ...
                    >
                      <span style={{ fontSize: 15 }}>
                        ...
                        locations in the Licensed Application; and (3) to
                        prescreen or delete any Contributions at any time and
                        for any reason, without notice. We have no obligation to
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            ...
                                            <bdt className="else-block" />
                                            .1 &nbsp;Licensor's responsibility
                                            in the case of violation of
                                            obligations and tort shall be
                                            limited to intent and gross
                                            negligence. Only in case of a breach
                                            of essential contractual duties
                                            (cardinal obligations), Licensor
                                            shall also be liable in case of
                                            slight negligence. In any case,
                                            liability shall be limited to the
                                            foreseeable, contractually typical
                                            damages. The limitation mentioned
                                            above does not apply to injuries to
                                            life, limb, or health.
                                            <span style={{ fontSize: 15 }}>
                                              <bdt className="statement-end-if-in-editor">
                                                <bdt className="block-component" />
                                      ...
                                      <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                          ...
                                          >
                                            ...
                                            any damages caused due to a breach
                                            of duties according to Section 2 of
                                            this{" "}
                                            <bdt className="block-component" />
                                            License
                                            <bdt className="statement-end-if-in-editor" />{" "}
                                            Agreement. To avoid data loss, You
                                            are required to make use of backup
                                            functions of the Licensed
                                            Application to the extent allowed by
                                            applicable third-party terms and
                                            conditions of use. You are aware
                                            that in case of alterations or
                                            manipulations of the Licensed
                                            Application, You will not have
                  ...
                  <span style={{ fontSize: 15 }}>
                    ...
                    >
                      ...
                      >
                        ...
                        <bdt className="else-block" />
                        .1 &nbsp;Licensor warrants that the Licensed Application
                        is free of spyware, trojan horses, viruses, or any other
                        malware at the time of Your download. Licensor warrants
                        that the Licensed Application works as described in the
                        user documentation.
                      </span>
                    </span>
                  </span>
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        <bdt className="block-component" />9
                                        <bdt className="else-block" />
                                        .2 &nbsp;No warranty is provided for the
                                        Licensed Application that is not
                                        executable on the device, that has been{" "}
                                        <bdt className="block-component" />
                                        unauthorizedly
                                        <bdt className="statement-end-if-in-editor" />{" "}
                                        ...
                                        parties, or if there are any other
                                        reasons outside of{" "}
                                        <bdt className="question">
                                          Stone Nature llc
                                        </bdt>
                                        's sphere of influence that affect the
                                        executability of the Licensed
                                        Application.
                                      </span>
                                    </bdt>
                                  </bdt>
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        <bdt className="block-component" />9
                                        <bdt className="else-block" />
                                        .3 &nbsp;You are required to inspect the
                                        Licensed Application immediately after
                                        installing it and notify{" "}
                                        <bdt className="question">
                                          Stone Nature llc
                                        </bdt>{" "}
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        consideration and further investigated
                                        if it has been emailed within a period
                                        of{" "}
                                        <bdt className="question">zero (0)</bdt>{" "}
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        <bdt className="block-component" />9
                                        <bdt className="else-block" />
                                        .4 &nbsp;If we confirm that the Licensed
                                        Application is defective,{" "}
                                        <bdt className="question">
                                          Stone Nature llc
                                        </bdt>{" "}
                                        reserves a choice to remedy the
                                        situation either by means of solving the
                      ...
                      <bdt data-type="body">
                        ...
                        >
                          ...
                          >
                            ...
                            In the event of any failure of the Licensed
                            Application to conform to any applicable warranty,
                            You may notify the Services Store Operator, and Your
                            Licensed Application purchase price will be refunded
                            to You. To the maximum extent permitted by
                            applicable law, the Services Store Operator will
                            have no other warranty obligation whatsoever with
                            respect to the Licensed Application, and any other
                            losses, claims, damages, liabilities, expenses, and
                            costs attributable to any negligence to adhere to
                            any warranty.
                          </span>
                        </div>
                      </bdt>
                      ...
                      <bdt data-type="body">
                        ...
                        >
                          ...
                          >
                            ...
                            faults expires after a statutory period of
                            limitation amounting to twelve (12) months after the
                            Licensed Application was made available to the user.
                            The statutory periods of limitation given by law
                ...
                <div style={{ textAlign: "left", lineHeight: 1 }}>
                  ...
                  >
                    <bdt className="question">
                      <span style={{ fontSize: 15 }}>Stone Nature llc</span>
                    </bdt>
                    ...
                    >
                      ledge that{" "}
                      <bdt className="question">Stone Nature llc</bdt>, and not
                      the Services, is responsible for addressing any claims of
                      the End-User or any third party relating to the Licensed
                      Application or the End-User’s possession and/or use of
                      ...
                      <bdt data-type="body">
                        ...
                        >
                          ...
                          >
                            ...
                            in a country that is subject to a US Government
                            embargo, or that has been designated by the US
                            Government as a <bdt className="block-component" />
                            "terrorist supporting"
                            <bdt className="statement-end-if-in-editor" />{" "}
                            country; and that You are not listed on any US
                    ...
                    <bdt data-type="conditional-block">
                      <bdt data-type="body">
                        ...
                        >
                          ...
                          >
                            <bdt className="question">Hamza Bozkir</bdt>
                            <bdt className="block-component" />
                          </span>
                        </div>
                      </bdt>
                      ...
                      <bdt data-type="body">
                        ...
                        >
                          ...
                          >
                            ...
                            license
                            <bdt className="statement-end-if-in-editor" /> is
                            valid until terminated by{" "}
                            <bdt className="question">Stone Nature llc</bdt> or
                            by You. Your rights under this{" "}
                            <bdt className="block-component" />
                            license
                            <bdt className="statement-end-if-in-editor" /> will
                            terminate automatically and without notice from{" "}
                            <bdt className="question">Stone Nature llc</bdt> if
                            You fail to adhere to any term(s) of this{" "}
                            <bdt className="block-component" />
                            license
                            ...
                            Application, and destroy all copies, full or
                ...
                <div style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt className="question">Stone Nature llc</bdt> will
                ...
                <div style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt className="block-component" />
                      "Instructions for Minimum Terms of Developer's End-User
                      License Agreement,"{" "}
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" /> subsidiaries shall be
                      third-party beneficiaries of this End User{" "}
                      <bdt className="block-component" />
                      License
                      <bdt className="statement-end-if-in-editor" /> Agreement
                      and — upon Your acceptance of the terms and conditions of
                      this <bdt className="block-component" />
                      License
                      <bdt className="statement-end-if-in-editor" /> Agreement,{" "}
                      <bdt className="block-component" /> will have the right
                      (and will be deemed to have accepted the right) to enforce
                      this End User <bdt className="block-component" />
                      License
                      <bdt className="statement-end-if-in-editor" /> Agreement
                ...
                <div style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    >
                      <bdt className="question">Stone Nature llc</bdt> and the
                      End-User acknowledge that, in the event of any third-party
                      claim that the Licensed Application or the End-User's
                      possession and use of that Licensed Application infringes
                      on the third party's intellectual property rights,{" "}
                      <bdt className="question">Stone Nature llc</bdt>, and not
                      the Services, will be solely responsible for the
                      investigation, <bdt className="block-component" />
                      defense
                      <bdt className="statement-end-if-in-editor" />,
                ...
                <div style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt className="block-component" />
                      <bdt className="block-component" />
                      the State of <bdt className="question">Georgia</bdt>
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" /> excluding its
                  ...
                  >
                    ...
                    <strong>
                      ...
                      >
                        <strong>
                          <span
                            style={{ lineHeight: "115%", fontFamily: "Arial" }}
                          >
                            <span style={{ fontSize: 19 }}>
                              <strong>
                                <span
                        ...
                        <bdt data-type="body">
                          ...
                          >
                            ...
                            >
                              ...
                              provisions shall not be affected. Invalid terms
                              will be replaced by valid ones formulated in a way
